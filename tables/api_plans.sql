...
(
    ...
    payment_required BOOL NULL COMMENT 'If set to true while the plan is active, this will not allow the user to make anymore requests until a payment has been processed to continue the subscription',
